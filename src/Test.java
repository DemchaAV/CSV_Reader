...
//        table.Table table = new table.Table(path+nameFile);
////        table.print();
//       table.Table table1 =  table.merridColumns(1,8);
////        System.out.println(table1.mapTable);
////        table1.print();
//        table1.wrap("\"");
////        table1.print();
//        table1 = table1.reduceColumns(2,1,5);
//        pritLog.Printable print = table1;
//        print.print();
//        System.out.println("                                         **************************************************************************************");
//        Thread.sleep(1000);
...
//        table.Cell cell = new table.Cell("Привет",1,2);
